...
```
## The Boundaries od Dynamodb
+ When you write a query you have provide a Primary Key (equality) eg. pk = 'phidel'
+ Are you allowed to "update" the Hash and Range?
 + No, whenever you change a key (simple or composite) eg. pk or sk you have to create a new item.
 + you have to delete the old one
+ Key condition expressions for query only for RANGE, HASH is only equality
+ Don't create UUID for entity if you don't have an access pattern for it
### Conversations Acess patterns 
#### Pattern A (Showing Single converstion)
...
```
``` ```mesaage_group_uuid comes from Pattern B
...
```
#### pattern D (update a message_group for last message)
